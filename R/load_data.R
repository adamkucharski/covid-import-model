...
data_proportion <- read_csv(paste0(data_path,"data/B.1.617-COG-UK-20210519.csv"))
...
data_india <- read_tsv(paste0(data_path,"data/outbreakinfo_mutation_report_data_2021-05-18.tsv"))
...
# To edit:
# Refactor theta_f in stochastic model
